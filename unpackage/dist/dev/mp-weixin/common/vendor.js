...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__8144ED1",
    appName: "XiangVisionCampus",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "192.168.10.1,192.168.81.1,172.16.48.221,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_wWhWSY";
...
function setConfig(configs) {
  ...
  index.shallowMerge(props$3, configs.props || {});
...
const props$1 = defineMixin({
  props: {
    ...
    safeAreaInsetTop: {
      type: Boolean,
      default: () => props$3.navbar.safeAreaInsetTop
    },
    // 固定在顶部时，是否生成一个等高元素，以防止塌陷
    placeholder: {
      type: Boolean,
      default: () => props$3.navbar.placeholder
    },
    // 是否固定在顶部
    fixed: {
      type: Boolean,
      default: () => props$3.navbar.fixed
    },
    // 是否显示下边框
    border: {
      type: Boolean,
      default: () => props$3.navbar.border
    },
    // 左边的图标
    leftIcon: {
      type: String,
      default: () => props$3.navbar.leftIcon
    },
    // 左边的提示文字
    leftText: {
      type: String,
      default: () => props$3.navbar.leftText
    },
    // 左右的提示文字
    rightText: {
      type: String,
      default: () => props$3.navbar.rightText
    },
    // 右边的图标
    rightIcon: {
      type: String,
      default: () => props$3.navbar.rightIcon
    },
    // 标题
    title: {
      type: [String, Number],
      default: () => props$3.navbar.title
    },
    // 标题颜色
    titleColor: {
      type: String,
      default: () => props$3.navbar.titleColor
    },
    // 背景颜色
    bgColor: {
      type: String,
      default: () => props$3.navbar.bgColor
    },
    ...
    titleWidth: {
      type: [String, Number],
      default: () => props$3.navbar.titleWidth
    },
    // 导航栏高度
    height: {
      type: [String, Number],
      default: () => props$3.navbar.height
    },
    // 左侧返回图标的大小
    leftIconSize: {
      type: [String, Number],
      default: () => props$3.navbar.leftIconSize
    },
    // 左侧返回图标的颜色
    leftIconColor: {
      type: String,
      default: () => props$3.navbar.leftIconColor
    },
    // 点击左侧区域(返回图标)，是否自动返回上一页
    autoBack: {
      type: Boolean,
      default: () => props$3.navbar.autoBack
    },
    // 标题的样式，对象或字符串
    titleStyle: {
      type: [String, Object],
      default: () => props$3.navbar.titleStyle
    }
  }
});
const props = defineMixin({
  props: {
    bgColor: {
      type: String,
      default: () => props$3.statusBar.bgColor
    },
    // 状态栏获取得高度
    height: {
      type: Number,
      default: () => props$3.statusBar.height
    }
  }
});
